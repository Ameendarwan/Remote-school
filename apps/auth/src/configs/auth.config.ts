import { seconds } from '@app/common/helper/constants/helper.function.constant';
...
export default registerAs(
  ...
  (): Record<string, any> => ({
    ...
    subject: process.env.AUTH_JWT_SUBJECT ?? 'takmil-backend-developoment',
    audience: process.env.AUTH_JWT_AUDIENCE ?? 'https://dev.takmil.com',
    issuer: process.env.AUTH_JWT_ISSUER ?? 'takmil-backend',
